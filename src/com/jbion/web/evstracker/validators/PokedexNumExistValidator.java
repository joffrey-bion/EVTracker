...
public class PokedexNumExistValidator implements Validator {
    ...
    private static final String POKEDEX_NUM_ALREADY_EXISTS_MSG = "This pok�dex number already exists.";
    ...
    public void validate(FacesContext context, UIComponent component, Object value)
        ...
        try {
            if (pokedexNum != null && speciesDao.findByPokedexNum(pokedexNum) != null) {
